    ...
    <div class="col-md-12">
        ...
        <div class="card p-4">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <form action="/admin/content/add/{{$course->id}}" method="post" enctype="multipart/form-data"> @csrf 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="desc" id="desc" rows="6" class="form-control @error('desc') is-invalid @enderror"></textarea>
                            @error('image')
                            <div class="invalid-feedback">
                                <p>{{ $message }}</p>
                            </div>
