      ...
      <div class="card px-3 py-3 mb-4">
        ...
        <form action="/admin/setting/edit" method="post">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              <label for="whatsapp">WhatsApp Number for Chat</label>
              <input type="text" name="whatsapp" id="whatsapp" value="{{$setting->whatsapp}}" class="form-control @error('whatsapp') is-invalid @enderror">
              @error('whatsapp')
              <div class="invalid-feedback">
                <p>{{ $message }}</p>
              </div>
